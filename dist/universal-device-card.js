...
`;function ot(t){return{switch:"mdi:toggle-switch",light:"mdi:lightbulb",fan:"mdi:fan",sensor:"mdi:eye",binary_sensor:"mdi:checkbox-marked-circle",select:"mdi:format-list-bulleted",number:"mdi:counter",button:"mdi:gesture-tap",climate:"mdi:thermostat",cover:"mdi:window-shutter",lock:"mdi:lock"}[t]||"mdi:circle-outline"}function rt(t){return{cool:"mdi:snowflake",heat:"mdi:fire",dry:"mdi:water-percent",fan_only:"mdi:fan",auto:"mdi:brightness-auto",off:"mdi:power"}[t]}function st(t){return{auto:"自動",low:"低速",medium:"中速",high:"高速",middle:"中速",favorite:"最愛",silent:"靜音",turbo:"強力"}[t]||t}const ct={climate:{cool:"rgba(3, 169, 244, 0.2)",heat:"rgba(255, 152, 0, 0.2)",dry:"rgba(156, 39, 176, 0.15)",fan_only:"rgba(76, 175, 80, 0.15)",auto:"rgba(0, 150, 136, 0.15)",off:"rgba(158, 158, 158, 0.1)"},light:{on:"rgba(255, 193, 7, 0.2)",off:"rgba(158, 158, 158, 0.1)"},fan:{on:"rgba(76, 175, 80, 0.2)",off:"rgba(158, 158, 158, 0.1)"},cover:{open:"rgba(3, 169, 244, 0.15)",opening:"rgba(3, 169, 244, 0.15)",closed:"rgba(158, 158, 158, 0.1)",closing:"rgba(158, 158, 158, 0.1)"},humidifier:{on:"rgba(33, 150, 243, 0.2)",off:"rgba(158, 158, 158, 0.1)"},media_player:{playing:"rgba(156, 39, 176, 0.2)",paused:"rgba(255, 152, 0, 0.15)",off:"rgba(158, 158, 158, 0.1)"},vacuum:{cleaning:"rgba(76, 175, 80, 0.2)",docked:"rgba(158, 158, 158, 0.1)",returning:"rgba(255, 152, 0, 0.15)"},water_heater:{electric:"rgba(255, 152, 0, 0.2)",gas:"rgba(255, 87, 34, 0.2)",off:"rgba(158, 158, 158, 0.1)"}};const lt={climate:function(t,e,i="standard",n=!0){const{current_temperature:a,temperature:o,fan_mode:r,fan_modes:s}=e.attributes,c=e.state,l="mini"===i;return"bar"===i?I`
        ...
        <!-- HVAC Mode 快速切換 (Bar) -->
        <div class="bar-modes">
          ${["cool","heat","dry","fan_only","auto","off"].map(e=>I`
      ...
      <div class="header ${l?"header-mini":""}">
        <div class="current-temp ${l?"current-temp-mini":""}">${a}<span class="unit">°C</span></div>
      ...
      <div class="quick-modes ${l?"quick-modes-mini":""}">
        ${["cool","heat","dry","fan_only","auto","off"].map(e=>I`
          <div class="mode-item ${c===e?"active":""} ${l?"mode-item-mini":""}" 
               @click="${()=>t._setClimateMode(e)}">
            <ha-icon icon="${rt(e)}"></ha-icon>
            ${l?"":I`<span class="mode-label">${t._t(e)}</span>`}
          </div>
        `)}
      </div>
      ...
      ${t._renderMainButtons(i)}
    `},light:function(t,e,i="standard",n=!0){const a="on"===e.state,o=e.attributes.brightness||0,r=Math.round(o/255*100),s="bar"===i,c="mini"===i,l=void 0!==e.attributes.brightness;return s?I`
        <div class="bar-content">
          <div class="bar-left">
            <div class="bar-icon ${a?"bar-icon-on":""}">
      ...
      <div class="header ${c?"header-mini":""}">
        <div class="${a&&l?"current-temp":"device-name"} ${c?"current-temp-mini":""}">
          ${a&&l?I`${r}<span class="unit">%</span>`:I`
            ${t._renderTitle(e.attributes.friendly_name||t._t("device"),i)}
            <span class="unit" style="font-size: 0.85rem; opacity: 0.8; display: block; margin-top: 2px;">${a?t._t("on"):t._t("off")}</span>
          `}
        </div>
        ${t._renderHeaderAction(n)}
      </div>
      ...
      <div class="main-control ${c?"main-control-mini":""}">
        <button class="power-btn ${a?"on":""} ${c?"power-btn-mini":""}" 
          ...
          <ha-icon icon="mdi:lightbulb${a?"":"-outline"}"></ha-icon>
          ${c?"":I`<span class="mode-label">${a?t._t("on"):t._t("off")}</span>`}
        </button>
      </div>
      ...
      ${t._renderMainButtons(i)}
    `},fan:function(t,e,i="standard",n=!0){const a="on"===e.state,o=e.attributes.percentage||0,r=e.attributes.preset_modes||[],s=e.attributes.preset_mode,c="mini"===i;return"bar"===i?I`
        <div class="bar-content">
          <div class="bar-left">
            <div class="bar-icon ${a?"bar-icon-on":""}">
              <ha-icon icon="mdi:fan"></ha-icon>
      ...
      `:I`
      <div class="header ${c?"header-mini":""}">
        <div class="${a?"current-temp":"device-name"} ${c?"current-temp-mini":""} ${a?"":"device-name-mini"}">
          ${a?I`${o}<span class="unit">%</span>`:t._renderTitle(e.attributes.friendly_name||t._t("device"),i)}
        </div>
        ${t._renderHeaderAction(n)}
      </div>
      ...
      `:""}
      ${t._renderMainButtons(i)}
    `},cover:function(t,e,i="standard",n=!0){const a=e.attributes.current_position||0;e.state;const o="mini"===i;return"bar"===i?I`
        <div class="bar-content">
          <div class="bar-left">
            <div class="bar-icon">
          ...
          <div class="bar-right">
            ${void 0!==e.attributes.current_position?I`
              <div class="bar-controls">
      ...
      <div class="header ${o?"header-mini":""}">
        <div class="${void 0!==e.attributes.current_position?"current-temp":"device-name"} ${o?"current-temp-mini":""} ${void 0===e.attributes.current_position?"device-name-mini":""}">
          ${void 0!==e.attributes.current_position?I`${a}<span class="unit">%</span>`:t._renderTitle(e.attributes.friendly_name||t._t("device"),i)}
        </div>
        ${t._renderHeaderAction(n)}
      </div>
      ...
      `:""}
      ${t._renderMainButtons(i)}
    `},humidifier:function(t,e,i="standard",n=!0){const a="on"===e.state,o=e.attributes.humidity||0,r="mini"===i;return"bar"===i?I`
        <div class="bar-content">
          <div class="bar-left">
            <div class="bar-icon ${a?"bar-icon-on":""}">
      ...
      <div class="header ${r?"header-mini":""}">
        <div class="${a?"current-temp":"device-name"} ${r?"current-temp-mini":""} ${a?"":"device-name-mini"}">
          ${a?I`${o}<span class="unit">%</span>`:t._renderTitle(e.attributes.friendly_name||t._t("device"),i)}
        </div>
        ${t._renderHeaderAction(n)}
      </div>
      ...
      <div class="main-control ${r?"main-control-mini":""}">
        <button class="power-btn ${a?"on":""} ${r?"power-btn-mini":""}" @click="${()=>t._toggleEntity()}">
          <ha-icon icon="mdi:air-humidifier"></ha-icon>
          ${r?"":I`<span class="mode-label">${a?t._t("on"):t._t("off")}</span>`}
        </button>
      </div>
      ...
      `:""}
      ${t._renderMainButtons(i)}
    `},media_player:function(t,e,i="standard",n=!0){const a=e.state,o=e.attributes.media_title||"No Media",r=e.attributes.media_artist||"",s="mini"===i;if("bar"===i)return I`
        <div class="bar-content">
          <div class="bar-left">
            <div class="bar-icon ${"playing"===a?"bar-icon-on":""}">
              <ha-icon icon="mdi:${"playing"===a?"play":"pause"}"></ha-icon>
            </div>
            <div class="bar-info">
          ...
          <div class="bar-right">
            ${void 0!==e.attributes.volume_level?I`
              <div class="bar-controls">
        ...
        ${t._renderMainButtons(i)}
      `;const c=void 0!==e.attributes.volume_level?Math.round(100*e.attributes.volume_level):0;return I`
      ...
      <div class="media-info ${s?"media-info-mini":""}">
        ...
        ${r&&!s?I`<div class="media-artist">${t._renderTitle(r,i,30)}</div>`:""}
      </div>
      ...
      ${t._renderMainButtons(i)}
    `},vacuum:function(t,e,i="standard",n=!0){const a=e.state,o=e.attributes.battery_level||0,r="mini"===i;return"bar"===i?I`
        <div class="bar-content">
          <div class="bar-left">
            <div class="bar-icon ${"cleaning"===a?"bar-icon-on":""}">
      ...
      ${t._renderMainButtons(i)}
    `},water_heater:function(t,e,i="standard",n=!0){const a=e.attributes.temperature||0,o=e.attributes.current_temperature||0,r="mini"===i;return"bar"===i?I`
        <div class="bar-content">
          <div class="bar-left">
            <div class="bar-icon">
      ...
      `:I`
      <div class="header ${r?"header-mini":""}">
        <div class="current-temp ${r?"current-temp-mini":""}">${o}<span class="unit">°C</span></div>
        ${t._renderHeaderAction(n)}
      </div>
      ...
      ${t._renderMainButtons(i)}
    `},generic:function(t,e,i="standard",n=!0){const a="mini"===i;return"bar"===i?I`
        <div class="bar-content">
          <div class="bar-left">
            <div class="bar-icon">
    ...
    `}_renderDeviceSpecificContent(t,e,i="standard",n=!0){return(lt[e]||lt.generic)(this,t,i,n)}_renderMainButtons(t){const e=this._getMainButtons();if(0===e.length)return"";const i="bar"===t;return I`
      <div class="main-buttons ${i?"main-buttons-bar":""}">
        ${e.map(t=>{const e=this._isEntityAvailable(t);return I`
            <button 
              ...
              ${i?"":I`<span>${t.attributes.friendly_name}</span>`}
            </button>
          `})}
      </div>
    `}_renderTitle(t,e,i=20){if(!t)return"";const n=("mini"===e||"bar"===e)&&t.length>i,a=n?t.substring(0,i)+"...":t;return n?I`
        <span class="truncated-text" 
              @click="${()=>this._showTextDialog(t)}" 
              title="${this._t("click_to_view")}">
          ${a}
        </span>
      `:I`<span>${a}</span>`}_renderPopup(){const t=this._getRelatedEntities(),e=t.filter(t=>t.entity_id.startsWith("sensor")),i=t.filter(t=>!t.entity_id.startsWith("sensor"));return I`
      <div class="popup-overlay" @click="${()=>this._showPopup=!1}">
        <div class="popup-content" @click="${t=>t.stopPropagation()}">
          ...
          `:I`<div class="no-controls">${this._t("no_controls")}</div>`}
        </div>
      </div>
    `}_renderControlCard(t){const e=t.entity_id.split(".")[0],i=this._isEntityAvailable(t);return I`
      <div class="control-card ${i?"":"control-card-unavailable"}">
        <div class="control-header">
          <ha-icon icon="${t.attributes.icon||ot(e)}"></ha-icon>
          <span>${t.attributes.friendly_name}</span>
          ${i?"":I`<span class="unavailable-badge">${this._t("unavailable")}</span>`}
        </div>
        
        <div class="control-action">
          ${i?this._renderControlAction(t,e):I`
