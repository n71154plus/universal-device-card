...
`;function st(t){return{switch:"mdi:toggle-switch",light:"mdi:lightbulb",fan:"mdi:fan",sensor:"mdi:eye",binary_sensor:"mdi:checkbox-marked-circle",select:"mdi:format-list-bulleted",number:"mdi:counter",button:"mdi:gesture-tap",climate:"mdi:thermostat",cover:"mdi:window-shutter",lock:"mdi:lock",humidifier:"mdi:air-humidifier",media_player:"mdi:play-circle",vacuum:"mdi:robot-vacuum",water_heater:"mdi:water-thermometer"}[t]||"mdi:circle-outline"}function ot(t){return{cool:"mdi:snowflake",heat:"mdi:fire",dry:"mdi:water-percent",fan_only:"mdi:fan",auto:"mdi:brightness-auto",off:"mdi:power"}[t]}function rt(t){return{auto:"自動",low:"低速",medium:"中速",high:"高速",middle:"中速",favorite:"最愛",silent:"靜音",turbo:"強力"}[t]||t}const ct={climate:{cool:"rgba(3, 169, 244, 0.2)",heat:"rgba(255, 152, 0, 0.2)",dry:"rgba(156, 39, 176, 0.15)",fan_only:"rgba(76, 175, 80, 0.15)",auto:"rgba(0, 150, 136, 0.15)",off:"rgba(158, 158, 158, 0.1)"},light:{on:"rgba(255, 193, 7, 0.2)",off:"rgba(158, 158, 158, 0.1)"},fan:{on:"rgba(76, 175, 80, 0.2)",off:"rgba(158, 158, 158, 0.1)"},cover:{open:"rgba(3, 169, 244, 0.15)",opening:"rgba(3, 169, 244, 0.15)",closed:"rgba(158, 158, 158, 0.1)",closing:"rgba(158, 158, 158, 0.1)"},humidifier:{on:"rgba(33, 150, 243, 0.2)",off:"rgba(158, 158, 158, 0.1)"},media_player:{playing:"rgba(156, 39, 176, 0.2)",paused:"rgba(255, 152, 0, 0.15)",off:"rgba(158, 158, 158, 0.1)"},vacuum:{cleaning:"rgba(76, 175, 80, 0.2)",docked:"rgba(158, 158, 158, 0.1)",returning:"rgba(255, 152, 0, 0.15)"},water_heater:{electric:"rgba(255, 152, 0, 0.2)",gas:"rgba(255, 87, 34, 0.2)",off:"rgba(158, 158, 158, 0.1)"}};function lt(t,e){return ct[t]?.[e]||"var(--ha-card-background)"}const dt={climate:function(t,e,i="standard",n=!0){const{current_temperature:a,temperature:s,fan_mode:o,fan_modes:r}=e.attributes,c=e.state,l="mini"===i;return"bar"===i?z`
        ...
        <!-- HVAC Mode 快速切換 (Bar) -->
        <div class="bar-modes">
          ${["cool","heat","dry","fan_only","auto","off"].map(e=>z`
            <div class="bar-mode-chip ${c===e?"active":""}" 
                 @click="${()=>t._setClimateMode(e)}"
                 title="${t._t(e)}">
              <ha-icon icon="${ot(e)}"></ha-icon>
            </div>
          `)}
        </div>
        ...
        ${r&&r.length>0?z`
          <div class="bar-fan-modes ${t._fanModeExpanded?"expanded":"collapsed"}">
            ...
            <div class="bar-fan-options ${t._fanModeExpanded?"expanded":"collapsed"}">
              ${r.map(e=>z`
                <div class="bar-fan-chip ${o===e?"active":""}"
      ...
      <div class="header ${l?"header-mini":""}">
        ...
        <div class="device-name ${l?"device-name-mini":""}">
          ...
          <span class="device-value">${a}°C → ${s}°C</span>
        </div>
      ...
      <div class="quick-modes ${l?"quick-modes-mini":""}">
        ${["cool","heat","dry","fan_only","auto","off"].map(e=>z`
          <div class="mode-item ${c===e?"active":""} ${l?"mode-item-mini":""}" 
               @click="${()=>t._setClimateMode(e)}">
            <ha-icon icon="${ot(e)}"></ha-icon>
            ${l?"":z`<span class="mode-label">${t._t(e)}</span>`}
          </div>
        `)}
      </div>
      ...
      ${r&&r.length>0?z`
        <div class="fan-mode-section ${l?"fan-mode-mini":""}">
          ...
          <div class="fan-mode-options ${l?"fan-mode-options-mini":""} ${t._fanModeExpanded?"expanded":"collapsed"}">
            ${r.map(e=>z`
              <div class="fan-mode-chip ${o===e?"active":""} ${l?"fan-mode-chip-mini":""}"
                   @click="${()=>t._setFanMode(e)}">
                ${rt(e)}
              </div>
            `)}
      ...
      ${t._renderMainButtons(i)}
    `},light:function(t,e,i="standard",n=!0){const a="on"===e.state,s=e.attributes.brightness||0,o=Math.round(s/255*100),r="bar"===i,c="mini"===i,l=void 0!==e.attributes.brightness;return r?z`
        <div class="bar-content">
          <div class="bar-left">
            ...
            <div class="bar-info">
              ...
              ${a&&l?z`
                <div class="bar-slider-container" @click="${e=>{e.stopPropagation(),t._handleSliderClick(e,"light")}}">
                  <div class="bar-slider-bg bar-slider-light" style="--slider-value: ${o}%"></div>
                  <div class="bar-slider-text">${o}%</div>
                </div>
              `:z`
      ...
      <div class="header ${c?"header-mini":""}">
        ...
        <div class="device-name ${c?"device-name-mini":""}">
          ${t._renderTitle(e.attributes.friendly_name||t._t("device"),i)}
          <span class="device-value">${a&&l?`${o}%`:a?t._t("on"):t._t("off")}</span>
        </div>
        ${t._renderHeaderAction(n)}
      </div>
      ...
      <div class="main-control ${c?"main-control-mini":""}">
        <button class="power-btn ${a?"on":""} ${c?"power-btn-mini":""}" 
          ...
          ${c?"":z`<span class="mode-label">${a?t._t("on"):t._t("off")}</span>`}
        </button>
      </div>
      ...
      ${t._renderMainButtons(i)}
    `},fan:function(t,e,i="standard",n=!0){const a="on"===e.state,s=e.attributes.percentage||0,o=e.attributes.preset_modes||[],r=e.attributes.preset_mode,c="mini"===i;return"bar"===i?z`
        <div class="bar-content">
          <div class="bar-left">
            ${t._renderBarIcon(e,a?"bar-icon-on":"")}
            <div class="bar-info">
              <div class="bar-name">${t._renderTitle(e.attributes.friendly_name,i)}</div>
              <div class="bar-state">${a?`${s}%`:t._t("off")}</div>
            </div>
          </div>
          <div class="bar-right">
            ${a&&void 0!==s?z`
        ...
        ${o.length>0?z`
          <div class="bar-modes">
            ${o.map(e=>{return z`
              <div class="bar-mode-chip ${r===e?"active":""}" 
      ...
      <div class="header ${c?"header-mini":""}">
        ...
        <div class="device-name ${c?"device-name-mini":""}">
          ${t._renderTitle(e.attributes.friendly_name||t._t("device"),i)}
          <span class="device-value">${a?`${s}%`:t._t("off")}</span>
        </div>
        ${t._renderHeaderAction(n)}
      </div>
      ...
      `:""}
      ${t._renderMainButtons(i)}
    `},cover:function(t,e,i="standard",n=!0){const a=e.attributes.current_position||0,s=e.attributes.current_tilt_position??0,o=e.state,r=e.attributes.supported_features??0,c=!!(48&r),l=!!(128&r)&&void 0!==e.attributes.current_tilt_position,d="mini"===i;return"bar"===i?z`
        <div class="bar-content">
          <div class="bar-left">
            ${t._renderBarIcon(e,"")}
            <div class="bar-info">
              <div class="bar-name">${t._renderTitle(e.attributes.friendly_name,i)}</div>
              <div class="bar-state">${a}%${l?` / ${s}%`:""}</div>
            </div>
          </div>
          <div class="bar-right">
            ${void 0!==e.attributes.current_position?z`
              <div class="bar-controls">
        ...
        <div class="bar-modes">
          <div class="bar-mode-chip ${"open"===o||"opening"===o?"active":""}"
               @click="${()=>t._callService("cover","open_cover")}"
               title="${t._t("open")}">
            <ha-icon icon="mdi:arrow-up"></ha-icon>
          </div>
          <div class="bar-mode-chip ${"opening"===o||"closing"===o?"active":""}"
               @click="${()=>t._callService("cover","stop_cover")}"
               title="${t._t("stop")}">
            <ha-icon icon="mdi:stop"></ha-icon>
          </div>
          <div class="bar-mode-chip ${"closed"===o||"closing"===o?"active":""}"
      ...
      <div class="header ${d?"header-mini":""}">
        ...
        <div class="device-name ${d?"device-name-mini":""}">
          ${t._renderTitle(e.attributes.friendly_name||t._t("device"),i)}
          ${void 0!==e.attributes.current_position?z`<span class="device-value">${a}%${l?` / ${s}%`:""}</span>`:""}
        </div>
        ${t._renderHeaderAction(n)}
      </div>
      ...
      ${void 0!==e.attributes.current_position?z`
        <div class="temp-control ${d?"temp-control-mini":""}">
          ...
          <div class="target-display">
            ...
            <span class="value ${d?"value-mini":""}">${a}%</span>
          </div>
          <button class="adj-btn ${d?"adj-btn-mini":""}" @click="${()=>t._adjustCoverPosition(10)}">
            <ha-icon icon="mdi:plus"></ha-icon>
          </button>
      ...
      `:""}
      ${t._renderMainButtons(i)}
    `},humidifier:function(t,e,i="standard",n=!0){const a="on"===e.state,s=e.attributes.humidity||0,o="mini"===i;return"bar"===i?z`
        <div class="bar-content">
          <div class="bar-left">
            ${t._renderBarIcon(e,a?"bar-icon-on":"")}
            <div class="bar-info">
      ...
      <div class="main-control ${o?"main-control-mini":""}">
        <button class="power-btn ${a?"on":""} ${o?"power-btn-mini":""}" @click="${()=>t._toggleEntity()}">
          <ha-icon icon="mdi:air-humidifier"></ha-icon>
          ${o?"":z`<span class="mode-label">${a?t._t("on"):t._t("off")}</span>`}
        </button>
      </div>
      ...
      ${a?z`
        <div class="temp-control ${o?"temp-control-mini":""}">
          ...
          <div class="target-display">
            ...
            <span class="value ${o?"value-mini":""}">${s}%</span>
          </div>
          <div style="width: 64px;"></div>
        </div>
      `:""}
      ${t._renderMainButtons(i)}
    `},media_player:function(t,e,i="standard",n=!0){const a=e.state,s=e.attributes.media_title||"No Media",o=e.attributes.media_artist||"",r="bar"===i,c="mini"===i,l={artist:[],album:[],playlist:[],track:[]};if(Array.isArray(t._massLibraryItems)&&t._massLibraryItems.forEach(t=>{const e=t.media_type;l[e]&&l[e].push(t)}),r){const o=void 0!==e.attributes.volume_level?Math.round(100*e.attributes.volume_level):0,r=t._showMassPlaylistOrLibrary(e);return z`
        <div class="bar-content">
          <div class="bar-left">
          ...
          <div class="bar-right">
            ${void 0!==e.attributes.volume_level?z`
              <div class="bar-controls">
                <button class="bar-btn" @click="${()=>t._adjustVolume(-5)}">
                  <ha-icon icon="mdi:minus"></ha-icon>
                </button>
                <span class="bar-value">${o}%</span>
                <button class="bar-btn" @click="${()=>t._adjustVolume(5)}">
                  <ha-icon icon="mdi:plus"></ha-icon>
                </button>
              </div>
        ...
        <div class="bar-modes">
          ...
          <div class="bar-mode-chip ${"playing"===a?"active":""}"
          ...
          `:""}
          ${r&&t._hasMusicAssistantLibrary()?z`
        ...
        ${t._isMusicAssistant(e)&&t._hasMassQueue()&&t._massQueueExpanded?z`
          <div class="mass-queue-foldable">
            <div class="mass-queue-list">
              ${t._massQueueLoading&&0===t._massQueueItems.length?z`<div class="mass-queue-empty">${t._t("mass_queue_loading")}</div>`:0===t._massQueueItems.length?z`<div class="mass-queue-empty">—</div>`:t._massQueueItems.map(e=>z`
                    <button class="mass-queue-item" @click="${()=>t._playMassQueueItem(e.queue_item_id)}">
                      <div class="mass-queue-item-image">
                        ${e.local_image_encoded?z`<img src="data:image/jpeg;base64,${e.local_image_encoded}" alt="" />`:e.media_image?z`<img src="${e.media_image}" alt="" />`:z`<ha-icon icon="mdi:music"></ha-icon>`}
                      </div>
                      <div class="mass-queue-item-info">
                        <span class="mass-queue-item-title">${e.media_title||"—"}</span>
                        ${e.media_artist?z`<span class="mass-queue-item-artist">${e.media_artist}</span>`:""}
                        ${e.media_album_name?z`<span class="mass-queue-item-album">${e.media_album_name}</span>`:""}
                      </div>
        ...
        ${t._isMusicAssistant(e)&&t._hasMusicAssistantLibrary()&&t._massLibraryExpanded?z`
          <div class="mass-queue-foldable">
            <div class="mass-library-section">
              ${t._massLibraryLoading&&0===t._massLibraryItems.length?z`<div class="mass-queue-empty">${t._t("mass_library_loading")}</div>`:0===t._massLibraryItems.length?z`<div class="mass-queue-empty">—</div>`:["artist","album","playlist","track"].map(e=>{const i=l[e]||[];return i.length?z`
                        <div class="mass-library-row">
                          <div class="mass-library-row-title">${e.toUpperCase()}</div>
                          <div class="mass-library-row-scroll">
                            ${i.map(e=>{const i=e.image||e.album?.image,n=e.artists?.map(t=>t.name).filter(Boolean).join(", ")||"",a=e.album?.name||"";return z`
                                <button class="mass-library-chip" @click="${()=>t._playMassLibraryItem(e)}">
                                  <div class="mass-library-chip-image">
                                    ${i?z`<img src="${i}" alt="" />`:z`<ha-icon icon="mdi:music"></ha-icon>`}
                                  </div>
        ...
        ${t._renderMainButtons(i)}
      `}const d=void 0!==e.attributes.volume_level?Math.round(100*e.attributes.volume_level):0,p=t._showMassPlaylistOrLibrary(e);return z`
      <div class="header ${c?"header-mini":""}">
        ${t._renderHeaderIcon(e,c)}
        <div class="device-name ${c?"device-name-mini":""}">
          ${t._renderTitle(e.attributes.friendly_name||t._t("device"),i)}
          ${z`<span class="device-value">${t._renderTitle(s,i,28)}</span>`}
        </div>
        ${p&&t._hasMassQueue()?z`
        ...
        `:""}
        ${p&&t._hasMusicAssistantLibrary()?z`
      ...
      <div class="media-info ${c?"media-info-mini":""}">
        ...
        ${o&&!c?z`<div class="media-artist">${t._renderTitle(o,i,30)}</div>`:""}
      </div>
      ...
      <div class="media-controls ${c?"media-controls-mini":""}">
        ...
        <button class="media-btn primary ${c?"media-btn-mini":""}" @click="${()=>t._callService("media_player","playing"===a?"media_pause":"media_play")}">
          <ha-icon icon="mdi:${"playing"===a?"pause":"play"}"></ha-icon>
        </button>
      ...
      ${t._renderMainButtons(i)}
    `},vacuum:function(t,e,i="standard",n=!0){const a=e.state,s=e.attributes.battery_level||0,o="mini"===i;return"bar"===i?z`
        <div class="bar-content">
          <div class="bar-left">
            ${t._renderBarIcon(e,"cleaning"===a?"bar-icon-on":"")}
            <div class="bar-info">
              <div class="bar-name">${t._renderTitle(e.attributes.friendly_name,i)}</div>
              <div class="bar-state">${t._getVacuumStateText(a)} · ${s}%</div>
            </div>
          </div>
          <div class="bar-right">
            <div class="bar-controls">
      ...
      <div class="header ${o?"header-mini":""}">
        ...
        <div class="device-name ${o?"device-name-mini":""}">
          ${t._renderTitle(e.attributes.friendly_name||t._t("device"),i)}
          <span class="device-value">${t._getVacuumStateText(a)} · ${s}%</span>
        </div>
        ${t._renderHeaderAction(n)}
      </div>

      <div class="vacuum-status ${o?"vacuum-status-mini":""}">
        <div class="status-badge ${o?"status-badge-mini":""}">${t._getVacuumStateText(a)}</div>
        <div class="battery-display ${o?"battery-display-mini":""}">
          <ha-icon icon="mdi:battery${s>90?"":s>50?"-50":"-20"}"></ha-icon>
          <span>${s}%</span>
        </div>
      </div>

      <div class="vacuum-controls ${o?"vacuum-controls-mini":""}">
        <button class="vacuum-btn ${o?"vacuum-btn-mini":""}" @click="${()=>t._callService("vacuum","start")}">
          <ha-icon icon="mdi:play"></ha-icon>
          <span>${t._t("start")}</span>
        </button>
        <button class="vacuum-btn ${o?"vacuum-btn-mini":""}" @click="${()=>t._callService("vacuum","pause")}">
          <ha-icon icon="mdi:pause"></ha-icon>
          <span>${t._t("pause")}</span>
        </button>
        <button class="vacuum-btn ${o?"vacuum-btn-mini":""}" @click="${()=>t._callService("vacuum","return_to_base")}">
          <ha-icon icon="mdi:home"></ha-icon>
          <span>${t._t("return_home")}</span>
        </button>
      </div>
      ${t._renderMainButtons(i)}
    `},water_heater:function(t,e,i="standard",n=!0){const a=e.attributes.temperature||0,s=e.attributes.current_temperature||0,o="mini"===i;return"bar"===i?z`
        <div class="bar-content">
          <div class="bar-left">
            ${t._renderBarIcon(e,"")}
            <div class="bar-info">
              <div class="bar-name">${t._renderTitle(e.attributes.friendly_name,i)}</div>
              <div class="bar-state">${s}°C → ${a}°C</div>
            </div>
          </div>
          <div class="bar-right">
            <div class="bar-controls">
      ...
      <div class="header ${o?"header-mini":""}">
        ...
        <div class="device-name ${o?"device-name-mini":""}">
          ${t._renderTitle(e.attributes.friendly_name||t._t("device"),i)}
          <span class="device-value">${s}°C → ${a}°C</span>
        </div>
        ${t._renderHeaderAction(n)}
      </div>

      <div class="temp-control ${o?"temp-control-mini":""}">
        <button class="adj-btn ${o?"adj-btn-mini":""}" @click="${()=>t._adjustWaterTemp(-1)}">
          <ha-icon icon="mdi:minus"></ha-icon>
        </button>
        <div class="target-display">
          <span class="label">${t._t("target_temp")}</span>
          <span class="value ${o?"value-mini":""}">${a}°C</span>
        </div>
        <button class="adj-btn ${o?"adj-btn-mini":""}" @click="${()=>t._adjustWaterTemp(1)}">
          <ha-icon icon="mdi:plus"></ha-icon>
        </button>
      ...
      ${t._renderMainButtons(i)}
    `},generic:function(t,e,i="standard",n=!0){const a="mini"===i;return"bar"===i?z`
        <div class="bar-content">
          <div class="bar-left">
            ${t._renderBarIcon(e,"")}
            <div class="bar-info">
    ...
    `}_renderDeviceSpecificContent(t,e,i="standard",n=!0){return(dt[e]||dt.generic)(this,t,i,n)}_renderMainButtons(t){const e=this._getMainButtons();if(0===e.length)return"";const i="bar"===t;return z`
      <div class="main-buttons ${i?"main-buttons-bar":""}">
        ${e.map(t=>{const e=this._isEntityAvailable(t);return z`
            <button 
              ...
              ${i?"":z`<span>${t.attributes.friendly_name}</span>`}
            </button>
          `})}
      </div>
    `}_renderTitle(t,e,i=20){return t?z`
      <span class="title-scroll-wrap" title="${t}">
        <span class="title-text">${t}</span>
      </span>
    `:""}_renderPopup(){const t=this._getRelatedEntities(),e=t.filter(t=>t.entity_id.startsWith("sensor")),i=t.filter(t=>!t.entity_id.startsWith("sensor"));return z`
      <div class="popup-overlay" @click="${()=>this._showPopup=!1}">
        <div class="popup-content" @click="${t=>t.stopPropagation()}">
          ...
          `:z`<div class="no-controls">${this._t("no_controls")}</div>`}
        </div>
      </div>
    `}_renderControlCard(t){const e=t.entity_id.split(".")[0],i=this._isEntityAvailable(t);return z`
      <div class="control-card ${i?"":"control-card-unavailable"}">
        <div class="control-header">
          <ha-icon icon="${t.attributes.icon||st(e)}"></ha-icon>
          <span>${t.attributes.friendly_name}</span>
          ${i?"":z`<span class="unavailable-badge">${this._t("unavailable")}</span>`}
        </div>
        
        <div class="control-action">
          ${i?this._renderControlAction(t,e):z`
            <span class="state-text unavailable-text">${t.state}</span>
          `}
        </div>
      </div>
    `}_renderControlAction(t,e){return function(t,e,i){const{html:n,toggle:a,setSelect:s,adjustNumber:o,pressButton:r,isEntityAvailable:c}=t,l=c(e);switch(i){case"switch":case"input_boolean":return n`
        <ha-switch 
          .checked="${"on"===e.state}"
          .disabled="${!l}"
      ...
      `;case"number":case"input_number":return n`
        <div class="number-control">
          <button ?disabled="${!l}" @click="${()=>l&&o(e.entity_id,-1)}">
            <ha-icon icon="mdi:minus"></ha-icon>
          </button>
          <span>${e.state}</span>
          <button ?disabled="${!l}" @click="${()=>l&&o(e.entity_id,1)}">
      ...
      `;case"button":return n`
        <button class="action-btn" ?disabled="${!l}" @click="${()=>l&&r(e.entity_id)}">
          <ha-icon icon="mdi:gesture-tap"></ha-icon>
        </button>
      `;default:return n`<span class="state-text">${e.state}</span>`}}({html:z,toggle:t=>this._toggleEntity(t),setSelect:(t,e)=>this._setSelect(t,e),adjustNumber:(t,e)=>this._adjustNumber(t,e),pressButton:t=>this._pressButton(t),isEntityAvailable:t=>this._isEntityAvailable(t)},t,e)}_setFanPresetMode(t){this._services?.setFanPresetMode(t)}_getVacuumStateText(t){return this._t(t)||t}_toggleEntity(t=this.config.entity){this._services?.toggle(t)}_callService(t,e){this._services?.callService(t,e)}_isMusicAssistant(t){return t&&t.attributes&&null!=t.attributes.mass_player_type}_hasMassQueue(){return null!=this.hass?.services?.mass_queue?.get_queue_items}async _fetchMassQueue(){if(this.config?.entity){this._massQueueLoading=!0,this._massQueueItems=[],this.requestUpdate("_massQueueLoading"),this.requestUpdate("_massQueueItems");try{let t=null;if(this.hass?.connection&&"function"==typeof this.hass.connection.sendMessagePromise){const e=await this.hass.connection.sendMessagePromise({type:"call_service",domain:"mass_queue",service:"get_queue_items",service_data:{entity:this.config.entity},return_response:!0});t=e?.result?.response??e?.response}if(null==t&&"function"==typeof this.hass?.callService){const e=await this.hass.callService("mass_queue","get_queue_items",{entity:this.config.entity},{},!0);t=e?.response??e?.result}let e=[];null!=t&&(Array.isArray(t)?e=t:t&&"object"==typeof t&&t[this.config.entity]?e=t[this.config.entity]:t&&"object"==typeof t&&(e=Object.values(t).flat())),this._massQueueItems=Array.isArray(e)?e:[]}catch(t){this._massQueueItems=[]}this._massQueueLoading=!1,this.requestUpdate("_massQueueItems"),this.requestUpdate("_massQueueLoading")}}_toggleMassQueueExpand(){this._massQueueExpanded=!this._massQueueExpanded,this._massQueueExpanded&&0===this._massQueueItems.length&&!this._massQueueLoading&&this._fetchMassQueue(),this.requestUpdate("_massQueueExpanded")}_playMassQueueItem(t){this.hass&&this.config?.entity&&this.hass.callService("mass_queue","play_queue_item",{entity:this.config.entity,queue_item_id:t})}_hasMusicAssistantLibrary(){return null!=this.hass?.services?.music_assistant?.get_library}async _getMassConfigEntryId(){if(this.config?.mass_config_entry_id)return this.config.mass_config_entry_id;if(!this.hass?.connection||!this.config?.entity)return null;try{const t=await this.hass.connection.sendMessagePromise({type:"config/entity_registry/get",entity_id:this.config.entity}),e=t?.result;if(e?.config_entry_id)return e.config_entry_id;const i=e?.device_id;if(i){const t=await this.hass.connection.sendMessagePromise({type:"config/device_registry/list"}),e=t?.result??[],n=Array.isArray(e)?e.find(t=>t.id===i):null,a=n?.config_entries??[];if(a.length>0)return a[0]}try{const t=await this.hass.connection.sendMessagePromise({type:"config_entries/get",domain:"music_assistant"}),e=t?.result??[],i=Array.isArray(e)&&e.length>0?e[0]:null;return i?.entry_id??i??null}catch(t){return null}}catch(t){return null}}async _fetchMassLibrary(){if(this.config?.entity){this._massLibraryLoading=!0,this._massLibraryItems=[],this.requestUpdate("_massLibraryLoading"),this.requestUpdate("_massLibraryItems");try{const t=await this._getMassConfigEntryId();if(!t)return void(this._massLibraryItems=[]);const e=[],i=["artist","album","playlist","track"],n={config_entry_id:t,limit:30},a=async t=>{const e={...n,media_type:t};if(this.hass?.connection&&"function"==typeof this.hass.connection.sendMessagePromise){const i=await this.hass.connection.sendMessagePromise({type:"call_service",domain:"music_assistant",service:"get_library",service_data:e,return_response:!0}),n=i?.result?.response??i?.response??i?.result,a=n?.items??(Array.isArray(n)?n:[]);return Array.isArray(a)?a.map(e=>({...e,media_type:t})):[]}if("function"==typeof this.hass?.callService){const i=await this.hass.callService("music_assistant","get_library",e,{},!0),n=i?.response??i?.result??i,a=n?.items??(Array.isArray(n)?n:[]);return Array.isArray(a)?a.map(e=>({...e,media_type:t})):[]}return[]};for(const t of i)try{const i=await a(t);e.push(...i)}catch(t){}this._massLibraryItems=e}catch(t){this._massLibraryItems=[]}finally{this._massLibraryLoading=!1,this.requestUpdate("_massLibraryItems"),this.requestUpdate("_massLibraryLoading")}}}_toggleMassLibraryExpand(){this._massLibraryExpanded=!this._massLibraryExpanded,this._massLibraryExpanded&&0===this._massLibraryItems.length&&!this._massLibraryLoading&&this._fetchMassLibrary(),this.requestUpdate("_massLibraryExpanded")}_playMassLibraryItem(t){this.hass&&this.config?.entity&&t?.uri&&this.hass.callService("music_assistant","play_media",{entity_id:this.config.entity,media_id:[t.uri],media_type:t.media_type||"track"})}_showMassPlaylistOrLibrary(t){return this._isMusicAssistant(t)&&(this._hasMassQueue()||this._hasMusicAssistantLibrary())}_setSelect(t,e){this._services?.setSelect(t,e)}_adjustNumber(t,e){this._services?.adjustNumber(t,e)}_pressButton(t){this._services?.pressButton(t)}_openMoreInfo(){this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:this.config.entity}}))}_fireHaptic(t="medium"){"undefined"!=typeof navigator&&navigator.vibrate&&navigator.vibrate("heavy"===t?[20,40,20]:[15,30,15]),this.dispatchEvent(new CustomEvent("haptic",{bubbles:!0,composed:!0,detail:{type:t}}))}_onIconPointerDown(t){this._iconLongPressFired=!1,this._iconLongPressTarget=t.currentTarget,this._iconLongPressTimer=setTimeout(()=>{this._iconLongPressTimer=null,this._iconLongPressFired=!0,this._fireHaptic("medium"),this._iconLongPressTarget&&(this._iconLongPressTarget.classList.add("icon-longpress-active"),setTimeout(()=>{this._iconLongPressTarget&&this._iconLongPressTarget.classList.remove("icon-longpress-active")},200)),this._openMoreInfo()},500)}_onIconPointerUp(){if(this._iconLongPressTimer&&(clearTimeout(this._iconLongPressTimer),this._iconLongPressTimer=null),this._iconLongPressTarget=null,this._iconLongPressFired)return void(this._iconLongPressFired=!1);const t=Date.now();if(this._iconLastTapTime&&t-this._iconLastTapTime<400)return this._iconLastTapTime=0,this._fireHaptic("light"),void this._openMoreInfo();this._iconLastTapTime=t,this._toggleEntity()}_onIconPointerLeave(){this._iconLongPressTimer&&(clearTimeout(this._iconLongPressTimer),this._iconLongPressTimer=null),this._iconLongPressTarget=null}_renderHeaderIcon(t,e=!1){if(!t)return"";const i=this._getDeviceType(),n=t.attributes?.icon||st(i),a=lt(i,t.state),s="var(--ha-card-background)"!==a&&a.startsWith("rgba")?a.replace(/[\d.]+\)$/,"1)"):"";return z`
    ...
    `}_renderBarIcon(t,e=""){if(!t)return"";const i=this._getDeviceType(),n=t.attributes?.icon||st(i);return z`
